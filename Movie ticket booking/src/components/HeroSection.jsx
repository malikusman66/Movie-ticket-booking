...
const HeroSection = () => {
  ...
  return (
    <div
      className="fade-in-up flex flex-col items-start justify-center gap-4 px-6 md:px-16 lg:px-36 bg-[url('/backgroundImage.png')] bg-cover bg-center h-screen"
    >
      <img src={marvelLogo} alt="" />
      <h1 className="text-5xl md:text-[70px] md:leading-18 font-semibold text-white max-w-110">
